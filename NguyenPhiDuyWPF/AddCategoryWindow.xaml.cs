...
namespace NguyenPhiDuyWPF
{
    public partial class AddCategoryWindow : Window
    {
        ...
        public AddCategoryWindow(Action reloadCallback, CategoryDTO category = null)
        {
            InitializeComponent();
            _reloadCallback = reloadCallback; // 🔴 dòng này bị thiếu trước đó
        ...
        private void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            _reloadCallback?.Invoke(); // 🟢 Gọi reload
